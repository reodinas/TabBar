...
import com.reodinas2.tabbar.adapter.PostingAdapter;
import com.reodinas2.tabbar.api.NetworkClient;
import com.reodinas2.tabbar.api.PostingApi;
import com.reodinas2.tabbar.config.Config;
import com.reodinas2.tabbar.model.Posting;
import com.reodinas2.tabbar.model.PostingList;
import com.reodinas2.tabbar.model.Res;
...
public class FirstFragment extends Fragment {
    ...
    // 프래그먼트는 화면연결을 onCreate이 아닌 onCreateView에 코드작성
    ...
    void getNetworkData(){
        ...
        SharedPreferences sp = getActivity().getSharedPreferences(Config.SP_NAME, getActivity().MODE_PRIVATE); // 또는 Context.MODE_PRIVATE
